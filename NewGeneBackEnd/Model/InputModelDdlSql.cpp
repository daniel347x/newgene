...
CREATE TABLE [main].[VG_DATA_METADATA__PRIMARY_KEYS] (
  ...
  [VG_DATA_TABLE_FK_DMU_CATEGORY_CODE] VARCHAR(128) NOT NULL ON CONFLICT FAIL REFERENCES [DMU_CATEGORY]([DMU_CATEGORY_STRING_CODE]) ON DELETE CASCADE ON UPDATE CASCADE, 
