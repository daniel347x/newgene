	...
	public:
		...
		class OutputGenerator
		{
			...
			private:
				...
				bool ProcessCurrentDataRowOverlapWithPreviousSavedRow(TimeRangeSorter & first_incoming_row, TimeRangeSorter & current_row_of_data, std::deque<TimeRangeSorter> & intermediate_rows_of_data, XR_TABLE_CATEGORY const xr_table_category);
