	...
	public:
		...
		class OutputGenerator
		{
			...
			private:
				...
				typedef std::map<int, TimeRanges> TimeRangesForIndividualGroup;
				...
				void EliminateRedundantNullsInFinalInnerTable(std::vector<SavedRowData> & saved_rows_with_null_in_final_inner_table, TimeRangesForIndividualGroup & group_time_ranges);
