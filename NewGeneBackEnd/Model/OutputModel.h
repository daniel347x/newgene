	...
	public:
		...
		class OutputGenerator
		{
			...
			private:
				...
				bool TestIfNewXRrowShouldBeInserted(bool & include_previous_data, bool & include_current_data, SavedRowData & current_row_of_data, XR_TABLE_CATEGORY const xr_table_category);
