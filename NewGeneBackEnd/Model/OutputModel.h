	...
	public:
		...
		class OutputGenerator
		{
			...
			private:
				...
				typedef std::map<std::vector<std::int64_t>, TimeRanges> TimeRangesForIndividualGroup_IntKeys;
				typedef std::map<std::vector<std::string>, TimeRanges> TimeRangesForIndividualGroup_StringKeys;
				...
				void EliminateRedundantNullsInFinalInnerTable(std::vector<SavedRowData> & saved_rows_with_null_in_final_inner_table, TimeRangesForIndividualGroup_IntKeys & group_time_ranges__intkeys, TimeRangesForIndividualGroup_StringKeys & group_time_ranges__stringkeys);
