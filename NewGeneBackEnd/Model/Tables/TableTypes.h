...
template<>
std::vector<FIELD_TYPE> const TableTypeTraits<TABLE_TYPE_VARIABLE_GROUP_IDENTIFIER>::types {FIELD_TYPE_UUID, FIELD_TYPE_UUID_FOREIGN, FIELD_TYPE_STRING_CODE, FIELD_TYPE_STRING_LONGHAND, FIELD_TYPE_NOTES_1, FIELD_TYPE_NOTES_2, FIELD_TYPE_NOTES_3};
template<>
std::vector<std::string> const TableTypeTraits<TABLE_TYPE_VARIABLE_GROUP_IDENTIFIER>::names {"VARIABLE_GROUP_IDENTIFIER_UUID", "UOA_IDENTIFIER_UUID", "VARIABLE_GROUP_IDENTIFIER_STRING_CODE", "VARIABLE_GROUP_IDENTIFIER_STRING_LONGHAND", "NOTES1", "NOTES2", "NOTES3"};
...
template<>
std::vector<FIELD_TYPE> const TableTypeTraits<TABLE_TYPE_VARIABLE_IDENTIFIER>::types {FIELD_TYPE_UUID, FIELD_TYPE_UUID_FOREIGN, FIELD_TYPE_FIELD_TYPE, FIELD_TYPE_STRING_CODE, FIELD_TYPE_STRING_LONGHAND, FIELD_TYPE_NOTES_1, FIELD_TYPE_NOTES_2, FIELD_TYPE_NOTES_3};
template<>
std::vector<std::string> const TableTypeTraits<TABLE_TYPE_VARIABLE_IDENTIFIER>::names {"VARIABLE_IDENTIFIER_UUID", "VARIABLE_GROUP_IDENTIFIER_UUID", "VARIABLE_IDENTIFIER_FIELD_TYPE", "VARIABLE_IDENTIFIER_STRING_CODE", "VARIABLE_IDENTIFIER_STRING_LONGHAND", "NOTES1", "NOTES2", "NOTES3"};
