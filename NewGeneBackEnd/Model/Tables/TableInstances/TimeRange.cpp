						...
						case DATA_CHANGE_INTENTION__UPDATE:
							{
								...
								std::for_each(change.child_identifiers.cbegin(), change.child_identifiers.cend(), [&db, &input_model_, &change, &changes_made,
											  this](WidgetInstanceIdentifier const & child_identifier)
								{
