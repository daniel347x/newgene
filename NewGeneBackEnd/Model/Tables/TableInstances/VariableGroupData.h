...
class Table_VariableGroupData : public Table<TABLE__VG_INPUT_DATA, TABLE_INSTANCE_IDENTIFIER_CONTAINER_TYPE__NONE>
{
	...
	public:
		...
		bool BuildImportDefinition(sqlite3 * db, InputModel * input_model_, WidgetInstanceIdentifier const & vg, std::vector<std::string> const & timeRangeCols,
								   ...
								   bool const inputFileContainsColumnDescriptions, bool const inputFileContainsColumnDataTypes, ImportDefinition & definition, std::string & errorMsg);
...
class Table_VariableGroupMetadata_PrimaryKeys : public Table<TABLE__VG_INPUT_DATA_METADATA_PRIMARY_KEYS, TABLE_INSTANCE_IDENTIFIER_CONTAINER_TYPE__MAP>
{
	...
	public:
		...
		bool AddDataTable(sqlite3 * db, InputModel * input_model_, WidgetInstanceIdentifier const & vg,
		...
		std::vector<std::pair<WidgetInstanceIdentifier, std::vector<std::string>>> GetColumnNamesCorrespondingToPrimaryKeys(sqlite3 * db, InputModel * input_model_,
