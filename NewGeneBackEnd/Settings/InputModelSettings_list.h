...
class InputModelSetting__string : public InputModelSetting, public StringSetting,
	public SimpleAccessProjectModelSetting<InputModelSetting__string<SETTING>, INPUT_MODEL_SETTINGS_NAMESPACE::INPUT_MODEL_SETTINGS, SETTING, SettingsManager, InputModelSettings>
{
...
template<INPUT_MODEL_SETTINGS_NAMESPACE::INPUT_MODEL_SETTINGS SETTING>
class InputModelSetting__path : public InputModelSetting, public PathSetting,
	public SimpleAccessProjectModelSetting<InputModelSetting__path<SETTING>, INPUT_MODEL_SETTINGS_NAMESPACE::INPUT_MODEL_SETTINGS, SETTING, SettingsManager, InputModelSettings>
{
