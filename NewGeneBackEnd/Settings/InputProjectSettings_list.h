...
class InputProjectBackendSetting__string : public BackendProjectInputSetting, public StringSetting,
	public SimpleAccessProjectModelSetting<InputProjectBackendSetting__string<SETTING>, INPUT_PROJECT_SETTINGS_BACKEND_NAMESPACE::INPUT_PROJECT_SETTINGS_BACKEND, SETTING, SettingsManager, InputProjectSettings>
{
...
template<INPUT_PROJECT_SETTINGS_BACKEND_NAMESPACE::INPUT_PROJECT_SETTINGS_BACKEND SETTING>
class InputProjectBackendSetting__path : public BackendProjectInputSetting, public PathSetting,
	public SimpleAccessProjectModelSetting<InputProjectBackendSetting__path<SETTING>, INPUT_PROJECT_SETTINGS_BACKEND_NAMESPACE::INPUT_PROJECT_SETTINGS_BACKEND, SETTING, SettingsManager, InputProjectSettings>
{
