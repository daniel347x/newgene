...
std::unique_ptr<BackendProjectSetting> SettingsManager::getSetting(Messager & messager, Project * project, PROJECT_SETTINGS_BACKEND_NAMESPACE::PROJECT_SETTINGS_BACKEND const which_setting)
{
	//if (project == NULL)
	//{
