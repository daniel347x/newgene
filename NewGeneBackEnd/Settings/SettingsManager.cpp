...
std::unique_ptr<BackendProjectInputSetting> SettingsManager::getSetting(Messager & messager, InputProjectSettings & project_settings,
...
std::unique_ptr<BackendProjectOutputSetting> SettingsManager::getSetting(Messager & messager, OutputProjectSettings & project_settings,
		OUTPUT_PROJECT_SETTINGS_BACKEND_NAMESPACE::OUTPUT_PROJECT_SETTINGS_BACKEND const which_setting)
{
	return project_settings.GetSetting(messager, which_setting);
}

std::unique_ptr<InputModelSetting> SettingsManager::getSetting(Messager & messager, InputModelSettings & model_settings,
...
std::unique_ptr<OutputModelSetting> SettingsManager::getSetting(Messager & messager, OutputModelSettings & model_settings,
