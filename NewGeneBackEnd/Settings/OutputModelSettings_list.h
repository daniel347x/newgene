...
class OutputModelSetting__string : public OutputModelSetting, public StringSetting,
	public SimpleAccessProjectModelSetting<OutputModelSetting__string<SETTING>, OUTPUT_MODEL_SETTINGS_NAMESPACE::OUTPUT_MODEL_SETTINGS, SETTING, SettingsManager, OutputModelSettings>
{
...
template<OUTPUT_MODEL_SETTINGS_NAMESPACE::OUTPUT_MODEL_SETTINGS SETTING>
class OutputModelSetting__path : public OutputModelSetting, public PathSetting,
	public SimpleAccessProjectModelSetting<OutputModelSetting__path<SETTING>, OUTPUT_MODEL_SETTINGS_NAMESPACE::OUTPUT_MODEL_SETTINGS, SETTING, SettingsManager, OutputModelSettings>
{
