...
class SettingsManager : public Manager<SettingsManager, MANAGER_DESCRIPTION_NAMESPACE::MANAGER_SETTINGS>
{
	...
	public:
		...
		std::unique_ptr<BackendProjectInputSetting> getSetting(Messager & messager, InputProjectSettings & project_settings,
				INPUT_PROJECT_SETTINGS_BACKEND_NAMESPACE::INPUT_PROJECT_SETTINGS_BACKEND const which_setting);
		std::unique_ptr<BackendProjectOutputSetting> getSetting(Messager & messager, OutputProjectSettings & project_settings,
		...
		std::unique_ptr<OutputModelSetting> getSetting(Messager & messager, OutputModelSettings & model_settings,
