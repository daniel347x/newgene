...
{
	public:
		WidgetDataItemRequest<VARIABLE_GROUPS_SUMMARY_SCROLL_AREA>(WIDGET_DATA_ITEM_REQUEST_REASON const reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
				WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItemRequest_base(reason_, identifier_)
		{
		}
...
{
	public:
		WidgetDataItem<VARIABLE_GROUPS_SUMMARY_SCROLL_AREA>(WIDGET_DATA_ITEM_REQUEST_REASON const request_reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
				WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItem_base(request_reason_, identifier_)
		{
		}
...
{
	public:
		WidgetDataItemRequest<VARIABLE_GROUPS_SUMMARY_VARIABLE_GROUP_INSTANCE>(WIDGET_DATA_ITEM_REQUEST_REASON const reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
				WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItemRequest_base(reason_, identifier_)
		{
		}
...
{
	public:
		WidgetDataItem<VARIABLE_GROUPS_SUMMARY_VARIABLE_GROUP_INSTANCE>(WIDGET_DATA_ITEM_REQUEST_REASON const request_reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
				WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItem_base(request_reason_, identifier_)
		{
		}
...
{
	public:
		WidgetDataItemRequest<KAD_SPIN_CONTROLS_AREA>(WIDGET_DATA_ITEM_REQUEST_REASON const reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
				WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItemRequest_base(reason_, identifier_)
		{
		}
...
{
	public:
		WidgetDataItem<KAD_SPIN_CONTROLS_AREA>(WIDGET_DATA_ITEM_REQUEST_REASON const request_reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
											   WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItem_base(request_reason_, identifier_)
		{
		}
...
{
	public:
		WidgetDataItemRequest<KAD_SPIN_CONTROL_WIDGET>(int const count_ = 0, WIDGET_DATA_ITEM_REQUEST_REASON const reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
				WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItemRequest_base(reason_, identifier_)
			, count(count_)
		{
...
{
	public:
		WidgetDataItem<KAD_SPIN_CONTROL_WIDGET>(int count_ = 0, WIDGET_DATA_ITEM_REQUEST_REASON const request_reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
												WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItem_base(request_reason_, identifier_)
			, count(count_)
		{
...
{
	public:
		WidgetDataItemRequest<TIMERANGE_REGION_WIDGET>(bool const do_random_sampling_ = false, std::int64_t random_sampling_count_per_stage_ = 1, bool consolidate_rows_ = true,
				bool display_absolute_time_columns_ = false, WIDGET_DATA_ITEM_REQUEST_REASON const reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
				WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItemRequest_base(reason_, identifier_)
...
{
	public:
		WidgetDataItem<TIMERANGE_REGION_WIDGET>(bool const do_random_sampling_ = false, std::int64_t random_sampling_count_per_stage_ = 1, bool const consolidate_rows_ = true,
												bool const display_absolute_time_columns_ = false, WIDGET_DATA_ITEM_REQUEST_REASON const request_reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
												WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItem_base(request_reason_, identifier_)
			, do_random_sampling(do_random_sampling_)
			, random_sampling_count_per_stage(random_sampling_count_per_stage_)
...
{
	public:
		WidgetDataItemRequest<DATETIME_WIDGET>(std::int64_t const the_date_time_ = 0, WIDGET_DATA_ITEM_REQUEST_REASON const reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
											   WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItemRequest_base(reason_, identifier_)
...
{
	public:
		WidgetDataItem<DATETIME_WIDGET>(std::int64_t the_date_time_ = 0, WIDGET_DATA_ITEM_REQUEST_REASON const request_reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
										WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItem_base(request_reason_, identifier_)
			, the_date_time(the_date_time_)
		{
...
{
	public:
		WidgetDataItemRequest<GENERATE_OUTPUT_TAB>(WIDGET_DATA_ITEM_REQUEST_REASON const reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
				WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItemRequest_base(reason_, identifier_)
		{
		}
...
{
	public:
		WidgetDataItem<GENERATE_OUTPUT_TAB>(WIDGET_DATA_ITEM_REQUEST_REASON const request_reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
											WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItem_base(request_reason_, identifier_)
		{
		}
...
{
	public:
		WidgetDataItemRequest<MANAGE_DMUS_WIDGET>(WIDGET_DATA_ITEM_REQUEST_REASON const reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
				WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItemRequest_base(reason_, identifier_)
		{
		}
...
{
	public:
		WidgetDataItem<MANAGE_DMUS_WIDGET>(WIDGET_DATA_ITEM_REQUEST_REASON const request_reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
										   WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItem_base(request_reason_, identifier_)
		{
		}
...
{
	public:
		WidgetDataItemRequest<MANAGE_UOAS_WIDGET>(WIDGET_DATA_ITEM_REQUEST_REASON const reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
				WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItemRequest_base(reason_, identifier_)
		{
		}
...
{
	public:
		WidgetDataItem<MANAGE_UOAS_WIDGET>(WIDGET_DATA_ITEM_REQUEST_REASON const request_reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
										   WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItem_base(request_reason_, identifier_)
		{
		}
...
{
	public:
		WidgetDataItemRequest<MANAGE_VGS_WIDGET>(WIDGET_DATA_ITEM_REQUEST_REASON const reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
				WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItemRequest_base(reason_, identifier_)
		{
		}
...
{
	public:
		WidgetDataItem<MANAGE_VGS_WIDGET>(WIDGET_DATA_ITEM_REQUEST_REASON const request_reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
										  WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItem_base(request_reason_, identifier_)
		{
		}
...
{
	public:
		WidgetDataItemRequest<LIMIT_DMUS_TAB>(WIDGET_DATA_ITEM_REQUEST_REASON const reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
											  WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItemRequest_base(reason_, identifier_)
		{
		}
...
{
	public:
		WidgetDataItem<LIMIT_DMUS_TAB>(WIDGET_DATA_ITEM_REQUEST_REASON const request_reason_ = WIDGET_DATA_ITEM_REQUEST_REASON__UNKNOWN,
									   WidgetInstanceIdentifier identifier_ = WidgetInstanceIdentifier())
			: WidgetDataItem_base(request_reason_, identifier_)
		{
		}
