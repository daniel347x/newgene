...
enum DATA_CHANGE_TYPE
{
	...
	, DATA_CHANGE_TYPE__OUTPUT_MODEL__CONSOLIDATE_ROWS_CHANGE
	, DATA_CHANGE_TYPE__OUTPUT_MODEL__DISPLAY_ABSOLUTE_TIME_COLUMNS
	...
	, DATA_CHANGE_TYPE__OUTPUT_MODEL__INPUT_DMU_OR_DMU_MEMBER_CHANGE
