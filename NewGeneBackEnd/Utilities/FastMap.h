...
using FastVector = std::vector<K, boost::pool_allocator<K, boost::default_user_allocator_new_delete, boost::details::pool::null_mutex, MAX_SIZE>>;

template<typename K, typename V, class Comp_ = std::less<K>, unsigned MAX_SIZE = 32>
using FastMap = std::map<K, V, Comp_, boost::fast_pool_allocator<std::pair<K const, V>, boost::default_user_allocator_new_delete, boost::details::pool::null_mutex, MAX_SIZE>>;

template<typename K, typename V, class Comp_ = std::less<K>, unsigned MAX_SIZE = 32>
using FastMapFlat = boost::container::flat_map<K, V, Comp_, boost::fast_pool_allocator<std::pair<K const, V>, boost::default_user_allocator_new_delete, boost::details::pool::null_mutex, MAX_SIZE>>;

template<typename K, class Comp_ = std::less<K>, unsigned MAX_SIZE = 32>
using FastSet = std::set<K, Comp_, boost::fast_pool_allocator<K, boost::default_user_allocator_new_delete, boost::details::pool::null_mutex, MAX_SIZE>>;

template<typename K, class Comp_ = std::less<K>, unsigned MAX_SIZE = 32>
using FastSetFlat = boost::container::flat_set<K, Comp_, boost::fast_pool_allocator<K, boost::default_user_allocator_new_delete, boost::details::pool::null_mutex, MAX_SIZE>>;
