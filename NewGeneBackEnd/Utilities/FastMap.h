...
template<typename K, typename V, class Comp_ = std::less<K>>
using FastMapRemaining = std::map<K, V, Comp_, boost::fast_pool_allocator<std::pair<K const, V>, boost::default_user_allocator_malloc_free, remaining_tag, boost::details::pool::null_mutex>>;

template<typename K, typename V, class Comp_ = std::less<K>>
using FastMapHits = std::map<K, V, Comp_, boost::fast_pool_allocator<std::pair<K const, V>, boost::default_user_allocator_malloc_free, hits_tag, boost::details::pool::null_mutex>>;

template<typename K, typename V, class Comp_ = std::less<K>>
using FastMapHitsConsolidated = std::map<K, V, Comp_, boost::fast_pool_allocator<std::pair<K const, V>, boost::default_user_allocator_malloc_free, hits_consolidated_tag, boost::details::pool::null_mutex>>;

template<typename K, typename V, typename MEMORY_TAG, class Comp_ = std::less<K>>
using FastMapMemoryTag = std::map<K, V, Comp_, boost::fast_pool_allocator<std::pair<K const, V>, boost::default_user_allocator_malloc_free, MEMORY_TAG, boost::details::pool::null_mutex>>;
