...
enum MESSAGER_MESSAGE_ENUM
{
	...
	, MESSAGER_MESSAGE__MAIN_PROJECT_NOT_AVAILABLE
	...
	, MESSAGER_MESSAGE__INPUT_MODEL_SETTINGS_NOT_CREATED
	, MESSAGER_MESSAGE__OUTPUT_MODEL_SETTINGS_NOT_CREATED
	, MESSAGER_MESSAGE__INPUT_MODEL_DATABASE_NOT_CREATED
	, MESSAGER_MESSAGE__OUTPUT_MODEL_DATABASE_NOT_CREATED
