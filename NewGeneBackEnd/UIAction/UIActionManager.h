...
class UIActionManager : public Manager<UIActionManager, MANAGER_DESCRIPTION_NAMESPACE::MANAGER_UI_ACTION>
{
	...
	public:
		...
		void DoVariableGroupSetMemberSelectionChange(Messager & messager, WidgetActionItemRequest_ACTION_VARIABLE_GROUP_SET_MEMBER_SELECTION_CHANGED const & action_request,
		...
		void SetVGDescriptions(Messager & messager, WidgetActionItemRequest_ACTION_SET_VG_DESCRIPTIONS const & action_request, InputProject & project);
		...
		void SetVGDescriptionsOutput(Messager & messager, WidgetActionItemRequest_ACTION_SET_VG_DESCRIPTIONS const & action_request, OutputProject & project);
