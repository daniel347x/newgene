...
class UILoggingManager : public QObject, public
	UIManager<UILoggingManager, LoggingManager, MANAGER_DESCRIPTION_NAMESPACE::MANAGER_LOGGING_UI, MANAGER_DESCRIPTION_NAMESPACE::MANAGER_LOGGING>
{
		Q_OBJECT
	public:
