	...
	QApplication( argc, argv )
{
	...
	qRegisterMetaType<WidgetDataItemRequest_VARIABLE_GROUPS_SUMMARY_SCROLL_AREA>();
	qRegisterMetaType<WidgetDataItemRequest_VARIABLE_GROUPS_SUMMARY_VARIABLE_GROUP_INSTANCE>();
	...
	qRegisterMetaType<WidgetDataItem_VARIABLE_GROUPS_SUMMARY_SCROLL_AREA>();
	qRegisterMetaType<WidgetDataItem_VARIABLE_GROUPS_SUMMARY_VARIABLE_GROUP_INSTANCE>();
	...
	qRegisterMetaType<WidgetActionItemRequest_ACTION_DATETIME_RANGE_CHANGE>();
