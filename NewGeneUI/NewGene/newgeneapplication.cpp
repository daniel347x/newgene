	...
	QApplication( argc, argv )
{
	...
	qRegisterMetaType<WidgetDataItemRequest_DATETIME_WIDGET>("WidgetDataItemRequest_TIMERANGE_REGION_WIDGET");
	...
	qRegisterMetaType<WidgetDataItem_DATETIME_WIDGET>("WidgetDataItem_TIMERANGE_REGION_WIDGET");
	...
	qRegisterMetaType<WidgetActionItemRequest_ACTION_DATETIME_RANGE_CHANGE>("WidgetActionItemRequest_ACTION_DO_RANDOM_SAMPLING_CHANGE");
	qRegisterMetaType<WidgetActionItemRequest_ACTION_DATETIME_RANGE_CHANGE>("WidgetActionItemRequest_ACTION_RANDOM_SAMPLING_COUNT_PER_STAGE_CHANGE");
