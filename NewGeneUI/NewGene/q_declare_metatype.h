...
Q_DECLARE_METATYPE(STD_VECTOR_WIDGETINSTANCEIDENTIFIER)
...
Q_DECLARE_METATYPE(WidgetDataItemRequest_LIMIT_DMUS_TAB)
...
Q_DECLARE_METATYPE(WidgetDataItem_LIMIT_DMUS_TAB)
...
Q_DECLARE_METATYPE(WidgetActionItemRequest_ACTION_CONSOLIDATE_ROWS_CHANGE)
Q_DECLARE_METATYPE(WidgetActionItemRequest_ACTION_DISPLAY_ABSOLUTE_TIME_COLUMNS_CHANGE)
...
Q_DECLARE_METATYPE(WidgetActionItemRequest_ACTION_LIMIT_DMU_MEMBERS_CHANGE)
...
Q_DECLARE_METATYPE(WidgetActionItemRequest_ACTION_SET_VG_DESCRIPTIONS)
