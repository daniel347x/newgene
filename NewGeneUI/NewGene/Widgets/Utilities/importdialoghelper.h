...
namespace ImportDialogHelper
{
	...
	void AddVgCreationBlock(QDialog & dialog, QFormLayout & form, QWidget & VgConstructionWidget, QVBoxLayout & formOverall, QWidget & VgConstructionPanes, QHBoxLayout & formConstructionPane, QVBoxLayout & formConstructionButtons, QListView *& listpane, WidgetInstanceIdentifiers const & uoas);
